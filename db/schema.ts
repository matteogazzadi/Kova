...
export const sportEnum = pgEnum('sport', ['running', 'cycling', 'triathlon', 'strength', 'other'])
export const levelEnum = pgEnum('level', ['beginner', 'intermediate', 'advanced'])
export const providerEnum = pgEnum('provider', ['strava', 'garmin', 'coros', 'fitbit', 'apple_health', 'manual', 'aggregator'])
export const workoutTypeEnum = pgEnum('workout_type', ['easy', 'tempo', 'interval', 'long', 'recovery', 'strength', 'race', 'other'])
