          ...
          <form action={formAction} className="space-y-5">
            ...
            <div className="grid gap-4 sm:grid-cols-2">
              <div className="space-y-2">
                ...
                {state.errors?.weightKg && (
                  <p className="text-xs text-destructive">{state.errors.weightKg[0]}</p>
                )}
              </div>
              <div className="space-y-2">
                ...
                {state.errors?.heightCm && (
                  <p className="text-xs text-destructive">{state.errors.heightCm[0]}</p>
                )}
              </div>
            </div>
            ...
            <div className="grid gap-4 sm:grid-cols-2">
              <div className="space-y-2">
                ...
                {state.errors?.sport && (
                  <p className="text-xs text-destructive">{state.errors.sport[0]}</p>
                )}
              </div>
              <div className="space-y-2">
            ...
            <div className="space-y-2">
              ...
              <Textarea
                id="goal"
                name="goal"
                placeholder="e.g. Run a sub-4h marathon in October 2025"
                rows={3}
              />
              {state.errors?.goal && (
                <p className="text-xs text-destructive">{state.errors.goal[0]}</p>
              )}
            </div>
            ...
            <div className="space-y-2">
              ...
              <Input
                ...
                placeholder="8"
              />
              {state.errors?.weeklyHoursAvailable && (
                <p className="text-xs text-destructive">
                  {state.errors.weeklyHoursAvailable[0]}
                </p>
              )}
            </div>
